            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Artí­culos
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">CÃ³digo</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="codigo" class="form-control" placeholder="CÃ³digo de barras">                                        
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="descripcion" class="form-control" placeholder="Ingrese descripciÃ³n">
                                    </div>
                                </div>
    ...
    'barcode': VueBarcode
        ...
        methods : {
            ...
            validarArticulo(){
                ...
                if (!this.nombre) this.errorMostrarMsjArticulo.push("El nombre del artículo no puede estar vací­o.");
                if (!this.stock) this.errorMostrarMsjArticulo.push("El stock del artículo debe ser un nÃºmero y no puede estar vacío.");
                if (!this.precio_venta) this.errorMostrarMsjArticulo.push("El precio venta del artí­culo debe ser un nÃºmero y no puede estar vacío.");
                    ...
                    case "articulo":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.modal=1;
                                this.tituloModal='Actualizar Artí­culo';
                                this.tipoAccion=2;
