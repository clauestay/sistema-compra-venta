                        ...
                        <div class="form-group row border">
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    >
                                    <span slot="no-options">lo siento, no hay opciones coincidentes.</span>
                                    </v-select>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="form-group row border">
                            ...
                            <label>Articulo <span style="color:red;" v-show="idarticulo==0">Seleccione(*)</span></label>
                                    <div class="form-inline">
                                        <input type="text" class="form-control" v-model="codigo" @keyup="buscarArticulo()" placeholder="Ingrese articulo">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterioA">
                                      ...
                                      <option value="descripcion">Codigo</option>
                                    </select>
                                    <input type="text" v-model="buscarA" @keyup.enter="listadoArticulos(buscarA,criterioA)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listadoArticulos(buscar,criterioA)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        data (){
            return {
                ...
                offset : 3,
                criterio : 'num_comprobante', //inicializado en num_comprobante
                buscar : '',
                criterioA : 'nombre',
                buscarA : '',
                arrayArticulo: [],
        ...
        methods : {
            ...
            buttonsStyling: false,
             ...
             listadoArticulos (buscar,criterio){
                let me=this;
                var url= '/articulo/listadoArticulos?buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
            ...
            abrirModal(modelo, accion, data = []){
                this.arrayArticulo=[];
                this.modal = 1;
                this.tituloModal = 'Seleccione uno o mas articulos';
            },
