...
class VentaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            //variable para trabajar con la zona horaria de mi pais
            $mytime = Carbon::now('America/Santiago');

            $venta = new Venta();
            $venta->idcliente = $request->idcliente;
            $venta->idusuario = \Auth::user()->id;//id del usuario logeado en el sistema.
            $venta->tipo_comprobante = $request->tipo_comprobante;
            $venta->serie_comprobante = $request->serie_comprobante;
            $venta->num_comprobante = $request->num_comprobante;
            $venta->fecha_hora = $mytime->toDateString();//cinvertirlo en fecha y hora manejable
            ...
            //almacenando detalle de ingreso
            $detalles = $request->data;//array de detalles

            //recorriendo el array de detalle
            ...
            DB::commit();
            //para poder generar el pdf al hacer el registr
            return ['id' => $venta->id];
